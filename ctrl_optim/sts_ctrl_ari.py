...
class SitToStandSim:
    ...
    def __init__(self, sim, env, use_tsa_full: bool = False, use_tsa: bool = False, params: Optional[STSReflexParams] = None, debug: bool = True, log_to_csv: bool = False):
        self.env = env
        self.sim = sim
